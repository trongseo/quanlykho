...
$this->title = Yii::t('app', 'Backup View');
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'monthavg'), 'url' => ['monthavg']];
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="wrap">
    <div class="container">
        <div class="monthavg-form">

            <form action="/index.php?r=avg%2Fmonthavg" method="post">
