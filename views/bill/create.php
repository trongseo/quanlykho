            ...
            <div class="bill-form">
                ...
                <form action="/index.php?r=bill%2Fcreate" method="post">
                    ...
                    <div class="form-group field-bill-idproduct required">
                        ...
                        <input type="text" id="bill-idproduct" class="form-control" name="idproduct" maxlength="128" aria-required="true">
                    ...
                    <div class="form-group field-bill-productname required">
                        ...
                        <input type="text" id="bill-productname" class="form-control" name="productname" maxlength="128" aria-required="true">
                    ...
                    <div class="form-group field-bill-count required">
                        ...
                        <input type="text" id="bill-count" class="form-control" name="count" maxlength="128" aria-required="true">
                    ...
                    <div class="form-group field-bill-idnhacungcap required">
                        ...
                        <input type="text" id="bill-idnhacungcap" class="form-control" name="idnhacungcap" aria-required="true">
